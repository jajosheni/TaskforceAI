module.exports = [
    {
        type: "function",
        name: "getAllTasks",
        description: "Retrieve all tasks from the task list.",
        strict: true,
        parameters: {
            type: "object",
            properties: {},
    ...
    },
    {
        ...
        description: "Confirm and create a task after user has reviewed the details.",
        strict: true,
        parameters: {
            type: "object",
            properties: {
    ...
    {
        type: "function",
        name: "confirmUpdateTask",
        description: "Confirm and apply full task update after user has reviewed the changes.",
        strict: true,
        parameters: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Delete a task from the system after user confirmation.",
        strict: true,
        parameters: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Request to delete a task. Should be followed by user confirmation before deletion.",
        strict: true,
        parameters: {
            type: "object",
            properties: {
                taskId: {
                    type: "number",
                    description: "The ID of the task the user wants to delete."
                }
            },
            required: ["taskId"],
            additionalProperties: false
